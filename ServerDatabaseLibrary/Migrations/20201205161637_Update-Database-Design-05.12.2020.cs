...
{
    public partial class UpdateDatabaseDesign05122020 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelationChatUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RelationChatUsers_Chats_ChatId",
                        column: x => x.ChatId,
                        principalTable: "Chats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RelationChatUsers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelationChatUsers_ChatId",
                table: "RelationChatUsers",
                column: "ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_RelationChatUsers_UserId",
                table: "RelationChatUsers",
                column: "UserId");
        }
